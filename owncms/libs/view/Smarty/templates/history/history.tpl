    ...
    <div class="login_right">
        ...
        <div style="width: 96%;clear: both;margin: 0 auto;font-family: 'Adobe 楷体 Std R';text-align: center;">
            ...
            <div style="width:96%;margin:5px 20px;">
                ...
                <a href="index.php?m=history&c=history&e=historyBranked&userID={$wordBaseRes.user_id}&wordID={$wordBaseRes.word_id}&smallTime=30">一个月内排名</a> &nbsp;|&nbsp;
                <a href="index.php?m=history&c=history&e=historyBranked&userID={$wordBaseRes.user_id}&wordID={$wordBaseRes.word_id}&smallTime=90">三个月内排名</a> &nbsp;|&nbsp;
                <a href="index.php?m=history&c=history&e=historyBranked&userID={$wordBaseRes.user_id}&wordID={$wordBaseRes.word_id}&smallTime=180">半年内排名</a></span></div>
        </div>
